...
Ph.D. candidate in Engineering with a strong research background in differentiable physics, PDE-constrained
optimization, and deep learning. With a strong record of publishing first-author papers in top-tier (Q1) journals and
presenting at international conferences.
Experienced in developing end-to-end differentiable frameworks and Generative AI solutions, and hands-on experience
with fine-tuning and training models such as Vision Transformers (ViTs) and Vision-Language Models (VLMs) for
advanced applications in perception, multi-modal learning, and embodied AI.
Motivated to contribute to state-of-the-art work at the intersection of physics, computer vision, and embodied AI –
driving innovation in robotics and embodied AI.
Education
...
optimization, and inverse problems, problems directly relevant to embodied AI research.
...
– Enhanced generative AI model accuracy by 8% through latent space analysis and dimensionality reduction (PCA,
UMAP)
